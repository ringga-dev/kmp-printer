...
const bundledLangs = {
"kotlin": () => import('@shikijs/langs/kotlin').then(r => r.default || r),
"kt": () => import('@shikijs/langs/kotlin').then(r => r.default || r),
"kts": () => import('@shikijs/langs/kotlin').then(r => r.default || r),
...
const options = {"theme":{"light":"material-theme-lighter","default":"github-dark","dark":"github-dark"}}
